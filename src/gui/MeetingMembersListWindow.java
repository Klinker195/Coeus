...
public class MeetingMembersListWindow extends GenericDialog {
	 ...
	 * Create the frame.
	 */
	public MeetingMembersListWindow(int DisplayWidth, int DisplayHeight, Integer MeetingID, String MeetingTitle, User ConnectedUser) {
	...
	private void searchEmployee(String Name, String Surname, String Email) {
		...
		ArrayList<Employee> ProjectMembersList = MainController.getEmployeeDAO().getEmployeeByMeetingID_Name_Surname_Email(MeetingID, Name, Surname, Email);
	...
	public void setData(Integer MeetingID, String MeetingTitle) {
		...
		if(MeetingTitle.length() > 60) {
			...
			TitleProjectName = MeetingTitle.substring(0, 60) + "...";
