...
public class ProjectUserSelectionWindow extends GenericDialog {
	...
	public ProjectUserSelectionWindow(Project Project, User ConnectedUser, int DisplayWidth, int DisplayHeight) {
		...
		ExitButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				MainController.getCoeusProjectManagerWindow().setPersonalProjectsData();
				MainController.getCoeusProjectManagerWindow().setGeneralProjectsData();
			}
		});
		...
		NextButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(ChosenMembersTable.getModel().getRowCount() != 0) {
					...
					MainController.getProjectDAO().insertProjectMembers((OngoingProject)Project, MembersCF);
					
					MainController.displayMessageDialog("Success!", "The employees have been successfully added to the project.");
		...
		JLabel ChoosenEmployeesListHeaderLabel = new JLabel("Project members:");
		...
		MembersLimitLabel = new JLabel();
		
		MembersLimitLabel.setText("/" + String.valueOf(Project.getMaxEmployee()));
		
		JLabel MembersListInfoBackgroundLabel = new JLabel("The project manager is already considered.");
		setDefaultBackgroundTextLabel(MembersListInfoBackgroundLabel);
		
		MembersLimitVariableLabel = new JLabel("1");
		MembersLimitVariableLabel.setHorizontalAlignment(SwingConstants.RIGHT);
						...
						.addGroup(gl_CentralPanel.createSequentialGroup()
							.addGroup(gl_CentralPanel.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_CentralPanel.createSequentialGroup()
									...
									.addGap(458)))
							.addGroup(gl_CentralPanel.createParallelGroup(Alignment.LEADING)
								.addComponent(ChoosenEmployeesListHeaderLabel, GroupLayout.PREFERRED_SIZE, 148, GroupLayout.PREFERRED_SIZE)
								.addGroup(gl_CentralPanel.createParallelGroup(Alignment.TRAILING, false)
									.addGroup(gl_CentralPanel.createSequentialGroup()
										.addComponent(MembersListInfoBackgroundLabel)
										.addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(MembersLimitVariableLabel, GroupLayout.PREFERRED_SIZE, 28, GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(MembersLimitLabel))
				...
				.addGroup(gl_CentralPanel.createSequentialGroup()
					...
					.addGroup(gl_CentralPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_CentralPanel.createSequentialGroup()
							.addGroup(gl_CentralPanel.createParallelGroup(Alignment.BASELINE)
								.addComponent(MembersLimitLabel)
								.addComponent(MembersLimitVariableLabel))
							.addGap(8)
							.addComponent(SearchByLabel))
						.addComponent(MembersListInfoBackgroundLabel))
					.addPreferredGap(ComponentPlacement.RELATED)
	...
	public void addMember() {
		...
		Integer CurrentMembers = Integer.parseInt(MembersLimitVariableLabel.getText());
		
		if(EmployeeTable.getSelectedRow() != -1 && CurrentMembers <= Project.getMaxEmployee()) {
			...
			if(!exists) {
				...
				CurrentMembers++;
				MembersLimitVariableLabel.setText(CurrentMembers.toString());
			}
	...
	private void searchEmployee(String Name, String Surname, String Email, String SkillName) {
		...
		ArrayList<Employee> ProjectMembersList = MainController.getEmployeeDAO().getEmployeeByName_Surname_Email_SkillNameOrderedByScoreWithoutProjectManager(Name, Surname, Email, SkillName, Score, MainController.getProjectDAO().getProjectManagerCFByProjectName(Project.getName()));
